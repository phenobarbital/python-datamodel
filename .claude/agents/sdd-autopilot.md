...
> **Note**: The examples below use illustrative paths from the original project.
> Adapt paths to this project's actual structure (e.g., `datamodel/` instead of `parrot/`).
...
## Comparison with AgentCrew (External Orchestrator)

| Aspect | AgentCrew (external orchestrator) | sdd-autopilot (Claude Code) |
|--------|----------------------|----------------------------|
